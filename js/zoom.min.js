...
function (f) {
 ...
 function" != typeof a.max) {
        ...
        _eZoom: function () {
            ...
            b = a.opts.flipbook, d = b.turn("view"), e = 0;
            e < d.length;
            e++) d[e] && this.trigger("zoom.resize", [a.scale, d[e], b.data().pageObjs[d[e]]])
        },
        _eStart: function (a) {
        ...
        _eTurning: function (a, b, d) {
            ...
            if (1 != a) {
                for (c = 0;
                c < d.length;
                c++) d[c] && this.trigger("zoom.resize", [a, d[c], b.data().pageObjs[d[c]]]);
                setTimeout(
        ...
        _eDestroying: function () {
            var a = this,
                ...
                d = b.opts.flipbook;
            this.zoom("zoomOut", 0);
            f.each("tap doubleTap resize zoomIn zoomOut swipeLeft swipeRight".split(" "),
